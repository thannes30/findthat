...
//       $('#user_username').css('border', 'solid green 3px')
//     } else {
//       $('#user_username').css('border', 'solid red 5px')
//     }
//   })

//     $('#user_email').on('keyup', function(){
//     if ($('#user_email').val().search(/^(([^<>()[\]\\.,;:\s@\"]+(\.[^<>()[\]\\.,;:\s@\"]+)*)|(\".+\"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/) > -1) {
//       $('#user_email').css('border', 'solid green 3px')
//     } else {
//       $('#user_email').css('border', 'solid red 5px')
//     }
//   })

//     $('#user_password').on('keyup', function(){
//     if ($('#user_password').val().length >= 5 && $('#user_password').val().length <= 10) {
//       $('#user_password').css('border', 'solid green 3px')
//     } else {
//       $('#user_password').css('border', 'solid red 5px')
//     }
//   })
// })
